        ...
        <main class="mx-auto max-w-7xl p-2 sm:px-6 sm:py-8">
            <div class="sm:text-center lg:text-left">
                <h1 class="text-4xl text-gray-900 font-bold tracking-tight sm:text-6xl">
                    <span class="block xl:inline">Stay focused and</span>
                    <span class="block text-pink-600 xl:inline">organized</span>
                </h1>
                <p class="mt-3 text-base text-gray-500 sm:mx-auto sm:mt-5 sm:max-w-xl sm:text-lg md:mt-5 md:text-xl lg:mx-0">{!! __('Become focused and organized with :app_name. Simple yet powerful to-do-list app for everyday use.', ['app_name' => '<span class="font-semibold">' . __( 'Laravel To Do List App' ) . '</span>']) !!}</p>
